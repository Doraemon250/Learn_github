...
TextInputDialog::TextInputDialog(wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style) : wxDialog(parent, id, title, pos, size, style)
{
	...
	m_staticText1 = new wxStaticText(this, wxID_ANY, wxT("输入标签"), wxDefaultPosition, wxDefaultSize, 0);
	...
	m_staticText2 = new wxStaticText(this, wxID_ANY, wxT("输入角度"), wxDefaultPosition, wxDefaultSize, 0);
	...
	m_button1 = new wxButton(this, wxID_OK, wxT("确认"), wxDefaultPosition, wxDefaultSize, 0);
	bSizer5->Add(m_button1, 0, wxALL, 5);

	m_button2 = new wxButton(this, wxID_CANCEL, wxT("取消"), wxDefaultPosition, wxDefaultSize, 0);
